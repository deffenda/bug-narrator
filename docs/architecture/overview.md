...
Track active risks in [GitHub Issues](https://github.com/deffenda/bugnarrator/issues). Use [docs/roadmap/roadmap.md](../roadmap/roadmap.md) for historical roadmap context only.
